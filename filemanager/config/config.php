...
/*$config['upload_dir'] = '/img/source/';
$config['current_path'] = '../img/source/';

$config['thumbs_upload_dir'] = '/img/thumbs/';
$config['thumbs_base_path'] = '../img/thumbs/';*/

$config['upload_dir'] = $_SESSION['folderUrl']."source/";

$config['current_path'] = "../".$_SESSION['folderUrl']."source/";

$config['thumbs_upload_dir'] = $_SESSION['folderUrl']."thumbs/";
$config['thumbs_base_path'] = $_SESSION['folderUrl']."/thumbs/";
